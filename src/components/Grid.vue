...
const isCombinedType = computed(() => {
  ...
  return type === 'PLATONIC_ROMANCE' || type === 'ROMANCE_NSFW' || type === 'PLATONIC_ROMANCE_NSFW';
});
...
const getSquareColorClass = (day: number) => {
  ...
  if (type === 'PLATONIC') {
    ...
    return 'square-nsfw';
  } else if (type === 'PLATONIC_ROMANCE') {
    return 'square-platonic-romance';
  } else if (type === 'ROMANCE_NSFW') {
    return 'square-romance-nsfw';
  } else if (type === 'PLATONIC_ROMANCE_NSFW') {
