...
<template>
    <div class="square-grid-container">
        ...
        <div class="pagination">
            ...
            <button v-for="page in totalPages" :key="page" class="page-button" :class="{ active: page === currentPage }" @click="goToPage(page)">
        ...
        <div class="square-grid">
            ...
            <div v-for="square in paginatedSquares" :key="square" class="square" @click="handleClick(square)">
